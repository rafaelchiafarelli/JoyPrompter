/****************************************************************************
** Meta object code from reading C++ file 'application_window.h'
**
...
#error "The header file 'application_window.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_ApplicationWindow[] = {
    "ApplicationWindow\0\0goToPrompt()\0"
    "getFile()\0saveFile()\0"
};

const QMetaObject ApplicationWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ApplicationWindow,
