...
QMAKE    = /usr/bin/qmake
JoyPrompter.xcodeproj/project.pbxproj: JoyPrompter.pro  /usr/local/Qt4.6/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.6/mkspecs/common/unix.conf \
	...
	$(QMAKE) -macx -o JoyPrompter.xcodeproj/project.pbxproj JoyPrompter.pro
